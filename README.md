...
The app allows users to start and track focus sessions, customize timer durations, and view detailed study statistics.
...
- Statistics screen with multiple views:
  - Daily statistics shown as vertical bar chart
  - Weekly average study time
  - Yearly average study time
- Daily statistics also display the selected day name and total studied minutes
...
- Statistics Screen:
  - Daily view with bar chart and total minutes per day
  - Weekly view showing average study time
  - Yearly view showing average study time
